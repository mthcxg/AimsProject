...
public class CompactDisc extends Disc implements Playable {
	private String artist, title, category, director;
	private float cost;
...
//toString
	...
	public String toString() {
		return String.format(
				"CompactDisc - Title:%-20s - Category:%-20s - Artist:%-20s - Director:%-20s - Length:%-10d - Cost:%.2f$\\n\"",
				this.getTitle(), this.getCategory(), this.getArtist(), this.getDirector(), this.getLength(),
				this.getCost());
	}
}
